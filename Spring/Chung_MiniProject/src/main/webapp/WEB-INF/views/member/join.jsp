	...
	<form action="member.join" 
		...
		<table id="joinTbl">
			...
			<tr>
				...
				<td><input name="c_photo" type="file" style="font-family: 'b';font-size: 13pt;font-weight:900;"></td>
			</tr>
			<tr>
				<td align="center" style="width:100px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;권한</td>
				<td><input name="c_role" type="radio" value="s" checked="checked">학생&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="c_role" type="radio" value="m">관리자</td>
			</tr>
			<tr>
